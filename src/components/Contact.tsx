              ...
              <div>
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center gap-3 p-4 border border-border bg-ink hover:border-primary/40 transition-colors"
                  >
                    <Mail className="h-4 w-4 text-primary flex-shrink-0" />
                    <div>
                      <div className="font-mono text-[0.62rem] tracking-[0.15em] uppercase text-muted-foreground">E-mail</div>
                      <div className="text-sm text-foreground">contato@nexumtec.com.br</div>
                    </div>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-sm text-foreground">+55 (21) 98146-6912</div>
                    </div>
                  </a>
                  <div className="flex items-center gap-3 p-4 border border-border bg-ink">
                    <MapPin className="h-4 w-4 text-primary flex-shrink-0" />
                    <div>
                      <div className="font-mono text-[0.62rem] tracking-[0.15em] uppercase text-muted-foreground">Localização</div>
                      <div className="text-sm text-foreground">Rio de Janeiro — RJ</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-border pt-6">
                ...
                <div className="flex gap-2">
                  <a
                    ...
                    className="nav-inline p-3 border border-border text-muted-foreground hover:border-primary hover:text-primary transition-colors"
                    aria-label="LinkedIn"
                  >
